...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/threedigrid-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6031&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/threedigrid-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `threedigrid` can be installed with `conda`:
...
```
mamba install threedigrid
```

It is possible to list all of the versions of `threedigrid` available on your platform with `conda`:
...
```
mamba search threedigrid --channel conda-forge
```
...
mamba repoquery search threedigrid --channel conda-forge

# List packages depending on `threedigrid`:
mamba repoquery whoneeds threedigrid --channel conda-forge

# List dependencies of `threedigrid`:
mamba repoquery depends threedigrid --channel conda-forge
```
